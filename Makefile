...
.PHONY : vts
vts : b_z249_000000.vts t_z249_000000.vts n_z249_000000.vts \
	t_z302_000000.vts n_z302_000000.vts \
	b_z357_000000.vts t_z357_000000.vts n_z357_000000.vts \
...
b_z249_000000.vts : bx_z249.sav by_z249.sav bz_z249.sav
	ipython ${python_script} vector $^ 0.249 ${time_points} b_z249 B ${kx} ${ky} None ${x_points} ${y_points}

t_z249_000000.vts : te_z249.sav
	ipython ${python_script} scalar $^ 0.249 ${time_points} te_z249 te ${kx} ${ky} None ${x_points} ${y_points}

n_z249_000000.vts : n_z249.sav
	ipython ${python_script} scalar $^ 0.249 ${time_points} n_z249 n ${kx} ${ky} None ${x_points} ${y_points}
...
t_z302_000000.vts : te_z249.sav
	ipython ${python_script} scalar $^ 0.302 ${time_points} te_z302 te ${kx} ${ky} None ${x_points} ${y_points}

n_z302_000000.vts : n_z249.sav
	ipython ${python_script} scalar $^ 0.302 ${time_points} n_z302 n ${kx} ${ky} None ${x_points} ${y_points}

b_z357_000000.vts : bx_z357.sav by_z357.sav bz_z357.sav
	ipython ${python_script} vector $^ 0.357 ${time_points} b_z357 B ${kx} ${ky} None ${x_points} ${y_points}

t_z357_000000.vts : te_z357.sav
	ipython ${python_script} scalar $^ 0.357 ${time_points} te_z357 te ${kx} ${ky} None ${x_points} ${y_points}

n_z357_000000.vts : n_z357.sav
	ipython ${python_script} scalar $^ 0.357 ${time_points} n_z357 n ${kx} ${ky} None ${x_points} ${y_points}

b_z416_000000.vts : bx_z416.sav by_z416.sav bz_z416.sav
	ipython ${python_script} vector $^ 0.416 ${time_points} b_z416 B ${kx} ${ky} None ${x_points} ${y_points}

t_z416_000000.vts : te_z416.sav
	ipython ${python_script} scalar $^ 0.416 ${time_points} te_z416 te ${kx} ${ky} None ${x_points} ${y_points}

n_z416_000000.vts : n_z416.sav
	ipython ${python_script} scalar $^ 0.416 ${time_points} n_z416 n ${kx} ${ky} None ${x_points} ${y_points}
